...
function initHALightbox() {
    ...
    const screenshots = document.querySelectorAll('.ha-screenshot-item img, .ha-screenshot-main img, .carousel-slide img, .ha-card img, .project-image img, .filament-photo img');
    let currentIndex = 0;
    let visibleItems = [];
