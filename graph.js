...
(() => {
  ...
  const N = [
    ...
    ['telemetry','Telemetrie','server','pages/server/telemetry/',6],
  ...
  const L = [
    ...
    ['server','adguard'],['server','router'],['server','tailscale'],['server','backups'],['server','audit'],['server','telemetry'],
    ['print','x1c'],['print','photon'],['print','drybox'],['print','prints'],
    ['games','gloom'],['games','frost'],['games','hexpole'],
    // křížové vazby = síť, ne strom
    ['monitoring','server'],['telemetry','ha'],['drybox','ha'],['hexpole','print'],['coach','ha'],['router','adguard'],['tailscale','router'],
    ['blog','backups'],['blog','hotkey'],['blog','adguard'],
    ['claude','coach'],['claude','gdpr'],['claude','brain'],['claude','hotkey'],['claude','telemetry'],
    ['docker','adguard'],['docker','server'],['docker','monitoring'],['docker','telemetry'],
